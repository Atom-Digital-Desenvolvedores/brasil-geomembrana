...
?>
	...
	<section class="wq-banner">
		...
		?>
			<div class="wq-banner_item">
				<figure>
					<?php getImageThumb($wsg_banner_items_img_id,'1920x650') ?>
				</figure>
	...
	<section class="wq-01">
		<div class="wq-container">
			<div class="wq-empresa_box">
				<div class="wq-flex">
					<div class="wq-box_5f wq-box_cp-12f wq-box_cl-12f wq-box_tp-6f wq-box_tl-6f">
						<figure>
							<?php
					...
					<div class="wq-box_7f wq-box_cp-12f wq-box_cl-12f wq-box_tp-6f wq-box_tl-6f">
						<div>
	...
	<!-- <section class="wq-grupo_geomembrana">
		<div class="wq-container">
			<h3 class="wq-titulo_1">Marcas do grupo</h3>
			<div class="wq-flex">
				<div class="wq-box_4 wq-box_cp-12">
					<figure>
						<img src="<?php bloginfo('template_url'); ?>/img/logo-01.png" alt="Embu Geomembrana" title="Embu Geomembrana">
					</figure>
				</div>
				<div class="wq-box_4 wq-box_cp-12">
					<figure>
						<img src="<?php bloginfo('template_url'); ?>/img/logo-02.png" alt="Goiás Impermeabilizações" title="Goiás Impermeabilizações">
					</figure>
				</div>
				<div class="wq-box_4 wq-box_cp-12">
					<figure>
						<img src="<?php bloginfo('template_url'); ?>/img/logo-03.png" alt="Goiás Geomembrana" title="Goiás Geomembrana">
					</figure>
				</div>
			</div>
		</div>
	...
	<section class="wq-04 wq-cto wq-projetos">
		<div class="wq-container">
